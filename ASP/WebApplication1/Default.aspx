            ...
            <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" AppointmentDataSourceID="ObjectDataSourceAppointment"
                ...
                <Storage>
                    <Appointments AutoRetrieveId="true">
                        ...
                        <CustomFieldMappings>
                            <dxwschs:ASPxAppointmentCustomFieldMapping Name="UserIDs" Member="UserIDs" ValueType="String" />
                            <dxwschs:ASPxAppointmentCustomFieldMapping Name="HostNotifications" Member="HostNotifications" ValueType="String" />
                        </CustomFieldMappings>
                    </Appointments>
                    <Resources>
